...
$sqlPacientes= " SELECT * FROM tipos WHERE Id=$id";
...
<div class="col-md-12 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            ...
            <form class="forms-sample" method="POST" action="../php/actualizar_tipo.php">
                ...
                <a href="../admin/tipos.php" class="btn btn-danger me-2">CANCELAR</a>
            </form>
        </div>
    </div>
</div>